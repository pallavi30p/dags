"""cdw-impala-sql-jwt — end-to-end CRUD DAG for Impala over CDW with JWT auth.

Identical shape to impala_sqlconn.py; differs only in dag_id and CONN_ID.
